...
def pii_scan(text: str, analyzer=None, anonymizer=None) -> dict:
    ...
    # Chỉ quét các loại PII mà assignment yêu cầu (VN_CCCD, VN_PHONE, EMAIL, PHONE).
    # Các recognizer NER mặc định (PERSON, LOCATION, DATE_TIME...) dùng spaCy tiếng Anh
    # nên tạo nhiều false positive trên văn bản tiếng Việt — không dùng ở đây.
